...
import com.twitswap.spark.config.KafkaConfig;
import com.twitswap.spark.config.KafkaProperties;
...
public class SparkService {
  ...
  public SparkService(SparkConf sparkConf, KafkaConfig kafkaConfig, KafkaProperties kafkaProperties) {
  ...
  public void run() {
    ...
    JavaInputDStream<ConsumerRecord<String, String>> messages = KafkaUtils.createDirectStream(
            ...
            ConsumerStrategies.Subscribe(topics, kafkaConfig.consumerConfigs()));
